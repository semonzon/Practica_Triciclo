# -*- coding: utf-8 -*-
"""
Created on Sat May  6 12:17:24 2023

@author: USUARIO
"""

'''
                    APARTADO 2 PRÁCTICA TRICICLO
Para este apartado, puede haber 2 o mas archivos con nodos.
En los archivos, las aristas tiene que estar de la forma (x,y) y una en cada linea.
Como ejemplo, se adjuntan 2 archivos en la misma carpeta que esta práctica con aristas. 
...
def main(textos):
    sc = SparkContext()
    todos_nodos = sc.emptyRDD()
    for file in textos:
        lista_nodos = sc.textFile(file)
        todos_nodos += lista_nodos
    rdd0 = todos_nodos.map(ordenar_nodos).distinct()
